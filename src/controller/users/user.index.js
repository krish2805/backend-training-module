...
function createControllers({ userRepo, hashPassword, comparePassword, userPermissionRepo}) {
  const userController = createUserController({
    ...
    createUserByPermissionUsecase: createUserByPermissionFactory({ userRepo, hashPassword, userPermissionRepo  }), });
